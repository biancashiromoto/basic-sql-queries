-- 5 - Write a query that selects data from the table products from the forth to the tenth records. Both fourth and tenth records have to be in the query. Do not use WHERE or ORDER BY.
