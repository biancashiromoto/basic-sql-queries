-- 19 - Select the count of orders that were made in table orders by employee_id equal to 5 or 6, and were sent by the method (column) shipper_id equal to 2. In the result, the column with the orders count must be called orders_count.
